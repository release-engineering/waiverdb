...
def _check_ldap_groups(
    user, testcase, ldap_host, ldap_searches, allowed_groups, use_gssapi=False
):
    """
...
def verify_authorization(
    ...
    if _check_ldap_groups(
        user, testcase, ldap_host, ldap_searches, allowed_groups, use_gssapi=use_gssapi
    ):
        return
